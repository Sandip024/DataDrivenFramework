...
public class TestConfig{
	...
	public static String from = "sandipnw28@gmail.com";
	public static String password = "Amdocs@1111";
	public static String[] to ={"sandipthopate1414@gmail.com","sandipthopate23@gmail.com"};
